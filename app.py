...
left_sidebar = html.Div(
    className="fixed top-16 left-0 bottom-0 w-64 bg-gray-100 p-5 overflow-y-auto shadow-lg z-40",
    children=[
...
# 主内容区域 - 位于中间，适应顶部和左侧固定元素
main_content = html.Div(
    className="ml-64 pt-16 min-h-screen bg-gray-50 p-6",
    children=[
        html.Div(
