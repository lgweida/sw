                                ...
                                dbc.Col(
                                    dbc.Card(
                                        [
                                            dbc.CardBody(
                                                [
                                                    html.H3("AI Platform & Trusted Distribution", className="card-title mb-4"),
                                                    html.Hr(),
                                                    html.H5("AI Platform", className="mt-3"),
                                                    html.P(
                                                        "The only unified AI platform for open source, saving users time, money, and risk.",
                                                        className="card-text"
                                                    ),
                                                    dbc.Button("Learn More", color="primary", href="/ai-platform", className="mb-4"),
                                                    html.Hr(),
                                                    html.H5("Trusted Distribution", className="mt-3"),
                                                    html.P(
                                ...
                                dbc.Col(
                                    dbc.Card(
                                        [
                                            dbc.CardBody(
                                                [
                                                    html.H3("Professional Services & Support", className="card-title mb-4"),
                                                    html.Hr(),
                                                    html.H5("Professional Services", className="mt-3"),
                                                    html.P(
                                                        "Expert guidance to accelerate your data science and AI initiatives.",
                                                        className="card-text"
                                                    ),
                                                    dbc.Button("Get Started", color="info", href="/professional-services", className="mb-4"),
                                                    html.Hr(),
                                                    html.H5("Enterprise Support", className="mt-3"),
                                                    html.P(
                                                        "Get dedicated support and training for your team's success with Anaconda.",
                                                        className="card-text"
                                                    ),
                                                    dbc.Button("Contact Us", color="warning", href="/contact")
                                                ]
                                            )
                                        ],
                                        className="h-100 shadow-lg"
