            ...
            html.Div([
                html.Div([
                    ...
                    html.Div([
                        ...
                        html.Button(
                            html.Span("✏️", className="text-sm"),
                            id={'type': 'edit-domain-button', 'index': i},
                            n_clicks=0,
                            title="Edit domain",
                            className="text-blue-600 hover:text-blue-800 hover:bg-blue-50 text-sm mr-1 px-2 py-1 border border-blue-300 rounded transition-colors duration-200"
                        ),
                        ...
                        html.Button(
                            ...
                            n_clicks=0,
                            title="Delete domain",
                            className="text-red-600 hover:text-red-800 hover:bg-red-50 text-sm px-2 py-1 border border-red-300 rounded transition-colors duration-200"
                        )
...
def handle_dialog_operations(add_clicks, close_clicks, cancel_clicks, edit_clicks, delete_clicks, submit_clicks, clear_clicks,
    ...
    if button_id == 'add-website-button':
        return True, "Manage Website Domains", "", -1, "Add Website", dash.no_update, ""
    ...
    # Handle edit button
        ...
        try:
            ...
            return dash.no_update, dash.no_update, domain_value, domain_index, "Update Website", dash.no_update, ""
        except:
    ...
    # Handle clear form button
        ...
        return dash.no_update, dash.no_update, "", -1, "Add Website", dash.no_update, ""
