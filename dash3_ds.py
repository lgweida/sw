...
left_sidebar = html.Div(
    ...
    children=[
        html.H4("Navigation", className="mb-4"),
        dbc.Nav(
            [
                dbc.NavLink("Dashboard", href="#", active=True),
                dbc.NavLink("Projects", href="#"),
                dbc.NavLink("Environments", href="#"),
                dbc.NavLink("Packages", href="#"),
                dbc.NavLink("Channels", href="#"),
        ...
        html.Hr(),
        html.H5("Quick Links", className="mt-4 mb-3"),
        dbc.Nav(
            [
                dbc.NavLink("Documentation", href="https://docs.anaconda.com/"),
                dbc.NavLink("Community", href="https://forum.anaconda.com/"),
                dbc.NavLink("Support", href="https://anaconda.com/app/support-center"),
            ],
            vertical=True,
        )
    ]
...
main_content = dbc.Container(
    ...
    style={
        "marginTop": "80px",
        "padding": "20px",
        "marginLeft": "250px",  # Make space for the left sidebar
